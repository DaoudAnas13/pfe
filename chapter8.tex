...
\item \textbf{ArchiveService:} 
  \begin{itemize}
    ...
    \item Maintains an archive log for traceability.
  \end{itemize}
...
\begin{itemize}
\item Web application dynamically renders report generation options based on active templates.
\item Users select filters and templates without hard-coded column mapping.
\item Report download is handled as a file stream to allow seamless interaction with large datasets.
