...
\item System creates request with initial status \texttt{DRAFT}.
...
Sequence Diagram : Coordinator request creation, template retrieval, request persistence, technician retrieval, dynamic rendering.
}}
\caption{Sprint 2 Request and Template Sequence}
...
\fbox{\parbox{0.9\textwidth}{
\centering
\includegraphics[width=0.9\textwidth]{umlTemp.png}
Class Diagram : RapportRequest, RapportTemplate, Project, Client, ReportLineData, and validation rule classes.
}}
\caption{Sprint 2 Domain Class Diagram }
...
\centering
\includegraphics[width=1\textwidth]{rqDataGridNew.png}
Angular UI : Tickets list with filters, request creation form, template management interface.
}}
\caption{ Sprint 2 Angular UI }
\label{fig:sprint2_class_placeholder}
\end{figure}
...
\fbox{\parbox{1\textwidth}{
\centering
\includegraphics[width=1\textwidth]{detNew.png}
Angular UI : Detailled Filtering system for tickets list 
}}
\caption{ Sprint 2 Angular UI }
\label{fig:sprint2_class_placeholder}
\end{figure}
...
\fbox{\parbox{1\textwidth}{
\centering
\includegraphics[width=1\textwidth]{detailsNew.png}
Angular UI : Intervention details view with dynamic form rendering and validation feedback.
}}
\caption{ Sprint 2 Angular UI }
\label{fig:sprint2_class_placeholder}
\end{figure}
...
Angular UI : Dynamic form rendering from template mapping with validation states.
}}
\caption{ Sprint 2 Angular UI }
\label{fig:sprint2_class_placeholder}
\end{figure}
...
\fbox{\parbox{1\textwidth}{
\centering
\includegraphics[width=1\textwidth]{editStatus.png}
Angular UI : Request status update interface with validation and transition rules.
}}
\caption{ Sprint 2 Angular UI }
\label{fig:sprint2_class_placeholder}
\end{figure}
...
\centering
\includegraphics[width=0.95\textwidth]{templateD.png}
Angular UI : Template management interface with JSON mapping editor.
}}
\caption{ Sprint 2 Angular UI }
\label{fig:sprint2_class_placeholder}
\end{figure}
...
\fbox{\parbox{0.95\textwidth}{
\centering
\includegraphics[width=0.95\textwidth]{suivi.png}
Flutter Mobile UI : Assigned interventions list with status indicators and dynamic form access.
}}
\caption{ Sprint 2 Flutter UI }
\label{fig:sprint2_class_placeholder}
\end{figure}
...
\fbox{\parbox{0.95\textwidth}{
\centering
\includegraphics[width=0.95\textwidth]{ticket.png}
Flutter Mobile UI : Intervention details with dynamic form rendering and validation feedback.
}}
\caption{ Sprint 2 Flutter UI }
\label{fig:sprint2_class_placeholder}
\end{figure}
...
\fbox{\parbox{1\textwidth}{
\centering
\includegraphics[width=1\textwidth]{dbReq.png}
Database : Rapport request and template schema with project/client/company relations.
}}
\caption{Sprint 2 Database Schema }
