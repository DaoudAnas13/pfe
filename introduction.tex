...
\item \textbf{Chapter 2: Analysis and Requirements Specification} formalizes actors, functional and non-functional requirements, use cases, and project constraints.
\item \textbf{Chapter 3: System Design} presents architectural and modeling choices, including process and data design.
\item \textbf{Chapter 4: Implementation} details the technical realization of major system components.
\item \textbf{Chapter 5: Results and Discussion} evaluates project outcomes, discusses performance and limitations, and analyzes achieved value.
\end{itemize}
