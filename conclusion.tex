...
\item \textbf{Evidence Capture:} File upload/download, automatic image optimization, geolocation tracking supporting accountability and documentation.
...
\textbf{Backend:}
\begin{itemize}
\item Spring Boot 2.7.3 with Spring Security for authentication and authorization
\item Spring Data JPA with custom repositories
\item PostgreSQL 10 with JSONB for flexible data structures
...
\textbf{Mobile:}
\begin{itemize}
\item Flutter 3.7 for cross-platform development
\item BLoC pattern for state management and architectural consistency
...
\begin{itemize}
\item \textbf{Sprint Planning:} Five three-week sprints with clear objectives
...
\item Integrate AI-based photo verification to detect incorrect component capture
\end{enumerate}
